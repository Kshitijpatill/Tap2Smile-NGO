...
export default function Topbar() {
    return (
        <div className="bg-brand-black text-white/80 py-2.5 border-b border-white/5 hidden md:block">
            <div className="container-custom flex justify-between items-center">
                <div className="flex items-center gap-8">
                    <a href="mailto:tap2smile@gmail.com" className="flex items-center gap-2 hover:text-brand-gold transition-colors text-xs font-medium uppercase tracking-widest">
                        <Mail className="w-3.5 h-3.5 text-brand-gold" />
                        tap2smile@gmail.com
                    </a>
                    <a href="tel:+917876602339" className="flex items-center gap-2 hover:text-brand-gold transition-colors text-xs font-medium uppercase tracking-widest">
